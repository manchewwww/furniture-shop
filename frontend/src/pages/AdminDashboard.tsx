              ...
              >
                ...
                >
                  <Form layout="vertical" form={deptForm}>
                    ...
                    <Form.Item
                      name="image_url"
                      label={t("admin.department_image")}
                    >
              ...
              >
                <Table
                  ...
                  columns={[
                    ...
                    { title: t("admin.category_name"), dataIndex: "name" },
                    {
                      title: t("admin.category_description"),
                      dataIndex: "description",
                    },
                    {
                ...
                >
                  <Form layout="vertical" form={categoryForm}>
                    <Form.Item
                      ...
                      rules={[{ required: true }]}
                    >
                      <Select placeholder={t("admin.department")}>
                        {depts.map((d: any) => (
                    ...
                    <Form.Item
                      name="description"
                      label={t("admin.category_description")}
                    >
                      <Input />
                    </Form.Item>
                  </Form>
