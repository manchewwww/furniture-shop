...
func Register(app *fiber.App, auth *handlers.AuthHandler, catalog *handlers.CatalogHandler, orders *handlers.OrdersHandler, admin *handlers.AdminHandler, payments *handlers.PaymentsHandler) {
	api := app.Group("/api")
