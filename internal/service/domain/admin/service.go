...
func (s *adminService) ListDepartments(ctx context.Context) ([]ec.Department, error) { return s.depts.List(ctx) }
func (s *adminService) CreateDepartment(ctx context.Context, d *ec.Department) error { return s.depts.Create(ctx, d) }
func (s *adminService) UpdateDepartment(ctx context.Context, id uint, d ec.Department) error { return s.depts.Update(ctx, id, d) }
func (s *adminService) DeleteDepartment(ctx context.Context, id uint) error { return s.depts.Delete(ctx, id) }

func (s *adminService) ListCategories(ctx context.Context) ([]ec.Category, error) { return s.cats.ListAll(ctx) }
func (s *adminService) CreateCategory(ctx context.Context, c *ec.Category) error { return s.cats.Create(ctx, c) }
func (s *adminService) UpdateCategory(ctx context.Context, id uint, c ec.Category) error { return s.cats.Update(ctx, id, c) }
func (s *adminService) DeleteCategory(ctx context.Context, id uint) error { return s.cats.Delete(ctx, id) }

func (s *adminService) ListProducts(ctx context.Context) ([]ec.Product, error) { return s.prods.ListAll(ctx) }
func (s *adminService) CreateProduct(ctx context.Context, p *ec.Product) error { return s.prods.Create(ctx, p) }
func (s *adminService) UpdateProduct(ctx context.Context, id uint, p ec.Product) error { return s.prods.Update(ctx, id, p) }
