...
func (s *adminService) CreateDepartment(ctx context.Context, d *models.Department) error {
	return s.depts.Create(ctx, d)
}
func (s *adminService) UpdateDepartment(ctx context.Context, id uint, d models.Department) error {
...
func (s *adminService) UpdateCategory(ctx context.Context, id uint, c models.Category) error {
...
func (s *adminService) ListProducts(ctx context.Context) ([]models.Product, error) {
	return s.prods.ListAll(ctx)
}
func (s *adminService) CreateProduct(ctx context.Context, p *models.Product) error {
	return s.prods.Create(ctx, p)
}
func (s *adminService) UpdateProduct(ctx context.Context, id uint, p models.Product) error {
...
func (s *adminService) ListProductOptions(ctx context.Context, productID *uint) ([]models.ProductOption, error) {
	return s.options.List(ctx, productID)
}
func (s *adminService) CreateProductOption(ctx context.Context, o *models.ProductOption) error {
	return s.options.Create(ctx, o)
}
func (s *adminService) UpdateProductOption(ctx context.Context, id uint, o models.ProductOption) error {
